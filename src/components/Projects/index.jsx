...
function Projects ({id,image,name, description}) {
  ...
  >
    ...
    />
        ...
        <Button id={id}  variant="light" className='ms-auto rounded-3'style ={{backgroundColor: "#212529"}}  onClick={() => {console.log(id); if(id === 'cqi') {navigate(`/projects/cqi`)} else {navigate(`/projects/${id}`)}}}>
