...
function Projects ({id,image,name, description, selectProject}) {
  return (
    <Card onClick={() => selectProject(id)} className ="container-fluid d-flex flex-column align-items-start justify-content-center py-5"style={{ width: '90%'}}>
        ...
        <Button id={id}  variant="light" className='mx-auto d-block rounded-3'style ={{backgroundColor: "#212529" , color : "#f8f9fa", margin : "5px", fontFamily : "roboto-medium", padding: "0.8rem", paddingLeft: "6rem", paddingRight: "6rem"}} onClick={() => selectProject(id)}>
        VIEW PROJECT
      </Button>
    </Card>
  );
