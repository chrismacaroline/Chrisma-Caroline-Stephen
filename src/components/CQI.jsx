      ...
      >
        <Card.Body className="container-fluid display-flex justify-content-center">
          <Card.Title
            ...
            className="text-left"
          >
            WebRTC Connection Quality Indicator (P2P Calls)
          </Card.Title>
        <Card.Subtitle style={{ fontSize: "1.2rem", paddingBottom: "0.5rem" }} className="text-left">
            In peer-to-peer calls, the absence of visual feedback around network quality often left users confused by distorted audio or dropped words. A WebRTC connection quality indicator was introduced to surface real-time network status directly within the call interface. By clearly signalling when call issues were network-related, this feature set clearer expectations, reduced user confusion, and improved overall confidence and experience during calls.
          </Card.Subtitle>
          <Card.Img
            variant="top"
            src="../../images/CQI main.svg"
